...
class ProductDisplaySelfLoad extends StatefulWidget {
  final String id;

  const ProductDisplaySelfLoad({required this.id});

 @override
  _ProductDisplaySelfLoad createState() => _ProductDisplaySelfLoad();
}

class _ProductDisplaySelfLoad extends State<ProductDisplaySelfLoad> {
...
void initState() {
  ...
  @override
  Widget build(BuildContext context) {
    return product == null ? Container() : Stack(
      children: <Widget>[
        Positioned(
            top: 30.0,
            right: 0,
            child: Container(
                ...
                Align(
                  ...
                  child: RichText(
                      text: TextSpan(children: [
                    TextSpan(
                        text: '\Rs. '+ Utils.thousandSeperate(product?.sale_price as String),
                        style: const TextStyle(
                            color: const Color(0xFFFFFFFF),
                            fontWeight: FontWeight.w400,
                            fontFamily: "Montserrat",
